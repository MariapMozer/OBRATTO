...
try:
    ...
    logger.warning(
        "Biblioteca 'resend' não instalada. Funcionalidade de email desabilitada."
    )
...
class EmailService:
    ...
    def __init__(self):
        ...
        if self.habilitado:
            ...
            if not RESEND_DISPONIVEL:
                logger.warning(
                    "EmailService desabilitado: biblioteca 'resend' não instalada"
                )
            elif not self.api_key:
                logger.warning(
                    "EmailService desabilitado: RESEND_API_KEY não configurada"
                )
    ...
    def enviar_email(
        ...
        try:
            ...
            logger.info(
                f"Email '{assunto}' enviado para {para_email} - ID: {email.get('id', 'N/A')}"
            )
            return True
    ...
    def enviar_boas_vindas(self, para_email: str, para_nome: str, perfil: str) -> bool:
        """
