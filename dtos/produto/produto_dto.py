...
class CriarProdutoDTO(BaseDTO):
    ...
    desconto: float = Field(default=0.0, ge=0, le=100, description="Percentual de desconto")
...
class AlterarProdutoDTO(BaseDTO):
    ...
    nome: Optional[str] = Field(None, min_length=3, max_length=100, description="Nome do produto")
    descricao: Optional[str] = Field(None, min_length=10, max_length=500, description="Descrição do produto")
    ...
    desconto: Optional[float] = Field(None, ge=0, le=100, description="Percentual de desconto")
