...
class CriarClienteDTO(CriarUsuarioDTO):
    ...
    def validar_genero(cls, v: Optional[str]) -> Optional[str]:
        return cls.validar_campo_wrapper(
            lambda valor, campo: validar_texto_opcional(valor, max_chars=20), "Gênero"
        )(v)
    ...
    def criar_exemplo_cliente_json(cls, **overrides) -> dict:
        ...
        exemplo = {"genero": "Feminino", "data_nascimento": "1990-01-01"}
...
CriarClienteDTO.model_config.update(
    {"json_schema_extra": {"example": CriarClienteDTO.criar_exemplo_cliente_json()}}
)
