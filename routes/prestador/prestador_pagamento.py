...
async def listar_cartoes(request: Request, usuario_logado: Optional[dict] = None):
    ...
    cartoes = cartao_repo.obter_cartoes_por_prestador(prestador_id)
    return templates.TemplateResponse(
        "publico/pagamento-prestador/meus_cartoes.html",
        {"request": request, "cartoes": cartoes, "id_prestador": prestador_id},
    )
...
async def mostrar_adicionar_cartao(
    ...
    prestador_id = usuario_logado["id"]
    return templates.TemplateResponse(
        "publico/pagamento-prestador/adicionar_cartao.html",
        {"request": request, "id_prestador": prestador_id},
    )
...
async def mostrar_editar_cartao(
    ...
    return templates.TemplateResponse(
        "publico/pagamento-prestador/adicionar_cartao.html",
        {"request": request, "cartao": cartao, "id_prestador": prestador_id},
    )
...
async def mostrar_confirmar_exclusao(
    ...
    if not cartao or cartao.id_fornecedor != prestador_id:
        return RedirectResponse(url="/prestador/pagamento/cartoes", status_code=303)
    return templates.TemplateResponse(
        "publico/pagamento-prestador/confirmar_exclusao_cartao.html",
